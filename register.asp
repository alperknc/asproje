...
<%
   if not isempty( Request.Form("log_button") ) Then
        ...
        Else
            message="KULLANICI KAYITLI DEGIL"    
        end if



        
    ElseIf not isempty( Request.Form("register_button") ) Then
        ...
        if row=0 Then
            if not username="" AND not email="" AND not password="" Then
            	sql = "INSERT INTO users (username,email,password,admin) VALUES ('"&username&"','"&email&"','"&password&"','no')"
            	con.execute (sql)
                message="KAYIT BASARILI"
            end if
        Else
            message="KULLANICI KAYITLI"    
        end if
    ...
    <div class="container" id="container">
        <div class="form-container sign-in-container">
            <form action="register.asp" method="post">
                ...
                <input type="text" name="log_username" placeholder="Kullanıcı Adı" value="" required>
    ...
    <div class="container right-panel-active" id="container">
        <div class="form-container right-panel-active sign-up-container right-panel-active">
            <form action="register.asp" method="post">
                ...
                <input type="text" name="reg_username" placeholder="Kullanıcı Adı" value="" required>
